...
#include "../CuPID/projectmanager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ProjectManager_t, stringdata) + ofs \
...
const QMetaObject ProjectManager::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ProjectManager.data,
      qt_meta_data_ProjectManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProjectManager.stringdata))
